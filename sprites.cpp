...
#define read(type, path)                                                       \
  {                                                                            \
    ...
    std::cout << #type << " " << time << " " << get_sprite(type).height()      \
              << 'x' << get_sprite(type).width() << std::endl;                 \
  }
