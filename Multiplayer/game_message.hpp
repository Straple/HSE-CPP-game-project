...
public:
  ...
  [[nodiscard]] const char *body() const { return m_data + header_length; }

  [[nodiscard]] char *body() { return m_data + header_length; }

  [[nodiscard]] std::size_t body_length() const { return m_body_length; }
  ...
  message_t message_type() const { return m_message_type; }
