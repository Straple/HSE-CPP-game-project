...
void draw_game_mode(
    ...
    switch (game_mode) {
        case (GM_GAME): {
            ...
            if (now_is_typing) {
                draw_rect2(
                    -global_variables::arena_half_size + Dot(10, 20), -global_variables::arena_half_size + Dot(162, 10),
                    BLACK
                );
                efloat text_size = 1;
        ...
        case (GM_CUSTOMIZATION): {
            ...
            draw_text_align(
                "press T to change the choice of customization (t-shirt or cloack)", Dot(0, -30), 0.5, GREEN
            );
