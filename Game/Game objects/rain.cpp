...
//struct Rain {
//
//	efloat time_before_start_rain;
//
//	efloat time_rain_start;
//
//	efloat rain_duration;
//
//	bool is_raining;
//
//	Rain() {
//		is_raining = false;
//
//		std::uniform_int_distribution<unsigned int> rnd_range(10, 20);
//
...
//				is_raining = true;
//				std::uniform_int_distribution<unsigned int> rnd_range(50, 50);
